...
.redb3 a{color:#6E090A; text-decoration: none;}	
.redb3 a:link{color:#6E090A;text-decoration:none ;} 
.redb3 a:visited{color:#6E090A} 
.redb3 a:hover{color:#6E090A} 
.redb3 a:active{color:#6E090A} 
.redb3-1{
	height:21px;
	width:185px;
	float:left;
...
.mb1left6{
	...
	width:331px;
	float:left;
	/* background:url('~@/assets/SXWB/cyzx.jpg'); */
}
.mb1left4_1{
	height:153px;
	width:331px;
...
.ilist .abs-bg {
    ...
    display: block;
    height: 125px;
    /* background: url('~@/assets/SXWB/pic-bg.png') 0 bottom repeat-x; */
    width: 100%;
}
.ilist .mb1left4_2 {
    position: absolute;
